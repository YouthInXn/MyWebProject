...
const share = new schema.Entity('share', {
  comments:[comment]
}, { idAttribute:'_id' })

const msgsList = [msgs]

const shareList = [share]
// 留言列表
export const normalizrData = (data) => {
...
export const normalizrShareList = (data) => {
  return normalize(data, shareList)
}
